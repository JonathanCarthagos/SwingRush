      ...
      <div className="flex flex-col items-center gap-2.5">
        <div className="flex flex-col items-center gap-[0.834rem]">
          <RevealText
            as="h2"
            text={heading}
            className="max-w-[calc(100vw-2rem)] whitespace-pre-line px-[0.08em] font-display text-[clamp(3.25rem,15.5vw,4rem)] leading-[0.86] text-brand-dark [text-wrap:balance]"
          />
